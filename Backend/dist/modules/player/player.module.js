...
exports.PlayerModule = PlayerModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: player_schema_1.Player.name, schema: player_schema_1.PlayerSchema }]),
        ],
        controllers: [player_controller_1.PlayerController],
        providers: [player_service_1.PlayerService],
        exports: [mongoose_1.MongooseModule, player_service_1.PlayerService],
    })
], PlayerModule);
